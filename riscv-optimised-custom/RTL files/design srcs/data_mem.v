...
input B,H;
input clk;
input [11:0] mem_address;//We need atleast 12 bits in the address to access 4K data words. Word alligned addressing followed by mapping +4 to +1
input [31:0] mem_data_write;
output reg [31:0]mem_data_read;
reg [31:0]mem_data_custom;
reg [11:0]mem_address_custom;
reg custom;

/*RAM*/
reg [31:0] mem_ram [0:4095];              //8KB of data memory, 2048 data words present in the memory
